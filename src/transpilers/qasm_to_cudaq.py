...
class QasmToCudaqTranspiler(BaseTranspiler):
    """Transpile OpenQASM to Cudaq Python code"""
    ...
    def supports(self, source: str, target: str) -> bool:
        return source == "qasm" and target == "cudaq"
