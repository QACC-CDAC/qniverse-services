...
class QasmToQuilTranspiler(BaseTranspiler):
    """Transpile OpenQASM to Quil Python code"""
    ...
    def supports(self, source: str, target: str) -> bool:
        return source == "qasm" and target == "quil"
