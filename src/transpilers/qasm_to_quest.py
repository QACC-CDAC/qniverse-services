...
class QasmToQuestTranspiler(BaseTranspiler):
    """Transpile OpenQASM to Quest Python code"""
    ...
    def supports(self, source: str, target: str) -> bool:
        return source == "qasm" and target == "quest"
