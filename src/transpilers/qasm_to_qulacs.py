...
class QasmToQulacsTranspiler(BaseTranspiler):
    """Transpile OpenQASM to Qulacs Python code"""
    ...
    def supports(self, source: str, target: str) -> bool:
        return source == "qasm" and target == "qulacs"
