...
class QasmToCirqTranspiler(BaseTranspiler):
    """Transpile OpenQASM to Cirq Python code"""
    ...
    def supports(self, source: str, target: str) -> bool:
        return source == "qasm" and target == "cirq"
